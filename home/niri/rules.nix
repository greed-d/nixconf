{...}: let
  ...
  windowRules = [
    ...
    {
      matches = [{app-id = "^(spotify|com.github.th_ch.youtube_music)$";}];
      open-on-workspace = "8";
    }
    {
    ...
    }
    {
      matches = [
        {
          app-id = "^(zen|firefox|chromium-browser|edge|chrome-.*|zen-.*|obsidian|org.telegram.desktop|vesktop|Element|org.gnome.Nautilus|com.github.th_ch.youtube_music)$";
        }
      ];
      open-maximized = true;
    }
